      ...
      >
        <div className="flex items-center justify-center h-full">
          <div className="text-white container mx-auto flex flex-col md:flex-row items-center px-6 relative z-10">
            <div className="md:w-1/2 text-center justify-center md:text-left mx-auto">
              ...
              <div className="flex  flex-col items-center lg:flex-row w-full text-center mx-auto justify-center lg:gap-4">
                <button className="w-2/3 sm:w-2/3 lg:w-auto flex items-center justify-center mt-6 px-5 py-2 bg-stone-700 hover:bg-orange-600 text-white text-sm lg:text-lg font-medium rounded-lg shadow-lg hover:scale-105 transition-transform">
                  <Wrench />
                  <p className="ml-2">Réparer mon iPhone</p>
                </button>
                <button className="w-2/3 sm:w-2/3 lg:w-auto flex items-center justify-center mt-6 px-5 py-2 bg-orange-600 text-white text-sm lg:text-lg font-medium rounded-lg shadow-lg hover:bg-stone-700 hover:scale-105 transition-transform">
                  <Phone />
